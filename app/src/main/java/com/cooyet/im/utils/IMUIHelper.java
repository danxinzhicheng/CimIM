...
import com.cooyet.im.imservice.entity.SearchElement;
import com.cooyet.im.imservice.event.LoginEvent;
import com.cooyet.im.imservice.event.SocketEvent;
import com.cooyet.im.ui.activity.GroupMemberSelectActivity;
import com.cooyet.im.ui.activity.MessageActivity;
import com.cooyet.im.ui.activity.UserInfoActivity;
import com.cooyet.im.ui.fragment.StateFragment;
import com.cooyet.im.utils.pinyin.PinYin.PinYinElement;
...
public class IMUIHelper {
    ...
    // 跳转到态势页面
    public static void openStateFragment(FragmentActivity ctx) {
        StateFragment frgament = new StateFragment();
        FragmentTransaction fragmentTransaction = ctx.getSupportFragmentManager()
                .beginTransaction();
        fragmentTransaction.replace(android.R.id.content, frgament);
