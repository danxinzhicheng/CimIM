...
import com.cooyet.im.protobuf.IMOther;
...
public class IMHeartBeatManager  extends  IMManager{
    ...
    private final String ACTION_SENDING_HEARTBEAT = "com.cooyet.im.imservice.manager.imheartbeatmanager";
    ...
    public void sendHeartBeatPacket(){
        ...
        PowerManager.WakeLock wl = pm.newWakeLock(PowerManager.PARTIAL_WAKE_LOCK, "cim_heartBeat_wakelock");
        wl.acquire();
        try {
