...
public class IMContactManager extends IMManager {
    ...
    private void reqGetAllUsers(int lastUpdateTime) {
        ...
        imSocketManager.sendRequest(imAllUserReq, sid, cid,false);
    }

    /**
     * ronghua.xie change id from string to int
     *
    ...
    public void reqGetDetaillUsers(ArrayList<Integer> userIds) {
        ...
        imSocketManager.sendRequest(imUsersInfoReq, sid, cid,false);
    }
    ...
    public void reqGetDepartment(int lastUpdateTime) {
        ...
        imSocketManager.sendRequest(imDepartmentReq, sid, cid,false);
    }
