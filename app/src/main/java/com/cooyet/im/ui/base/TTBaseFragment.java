...
import com.cooyet.im.ui.widget.DrawableCenterEditText;
import com.cooyet.tools.ScreenTools;
import com.cooyet.im.R;
import com.cooyet.im.ui.activity.SearchActivity;
import com.cooyet.im.utils.Logger;
import com.cooyet.im.ui.widget.SearchEditText;
import com.cooyet.im.ui.widget.TopTabButton;
...
public abstract class TTBaseFragment extends Fragment {
    ...
    protected DrawableCenterEditText search_input;
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        search_input = (DrawableCenterEditText) topContentView.findViewById(R.id.search_input);

        topContactFrame = (FrameLayout) topContentView.findViewById(R.id.contactTopBar);
        spaceView = topContentView.findViewById(R.id.space_view);
    ...
    protected void showContactTopBar() {
        ...
        search_input.setHint("搜索通讯录好友");
    }

    protected void hideContactTopBar() {
        topContactFrame.setVisibility(View.GONE);
        topContactTitle.setVisibility(View.GONE);
        spaceView.setVisibility(View.GONE);
        search_input.setHint("搜索好友");
    }
    ...
    protected void hideTopBar() {
        ...
        linearParams.height = ScreenTools.instance(getActivity()).dip2px(55);
        topContactFrame.setLayoutParams(linearParams);
        topContactFrame.setPadding(0, ScreenTools.instance(getActivity()).dip2px(00), 0, 0);
    }
