...
/**
 * @author : ronghua.xie on 14-12-31.
...
//            return bytes;
//        }
        Log.i("danmo", "getSendContent audioPath:" + audioPath);
        Log.i("danmo", "getSendContent bytes:" + bytes.length);
        return bytes;
//        int contentLength = bytes.length;
//        Log.i("danmo", "bytes.length:" + contentLength);
