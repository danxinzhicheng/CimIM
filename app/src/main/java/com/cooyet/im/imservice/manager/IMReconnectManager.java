...
//                        || IMSocketManager.instance().isSocketConnect()
    ...
    /**--------------------boradcast-广播相关-----------------------------*/
    private final String  ACTION_RECONNECT = "com.cooyet.im.imlib.action.reconnect";
    ...
    private void acquireWakeLock() {
        try {
            if (null == wakeLock) {
                ...
                wakeLock = pm.newWakeLock(PowerManager.PARTIAL_WAKE_LOCK, "cim_reconnecting_wakelock");
