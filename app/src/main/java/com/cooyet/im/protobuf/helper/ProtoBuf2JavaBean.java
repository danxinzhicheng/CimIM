...
import com.cooyet.im.imservice.entity.MsgAnalyzeEngine;
...
public class ProtoBuf2JavaBean {
    ...
    public static SessionEntity getSessionEntity(IMBaseDefine.ContactSessionInfo sessionInfo) {
        ...
        Log.i("1212", "sessionInfo.getSessionType:" + sessionInfo.getSessionType());
        Log.i("1212", "sessionInfo.getSessionId:" + sessionInfo.getSessionId());
        ...
        String desMessage = new String(com.cooyet.im.Security.getInstance().DecryptMsg(content));
        // 判断具体的类型是什么
