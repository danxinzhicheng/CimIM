...
public interface SysConstant {
    ...
    /**协议头相关 start*/
	public static final int PROTOCOL_HEADER_LENGTH = 20;// 默认消息头的长度
	public static final int PROTOCOL_VERSION = 2018;
    public static final int PROTOCOL_VERSION_PC = 2017;
    ...
    public static final int PROTOCOL_USERID = 0;
    public static final int PROTOCOL_CHANNEL = 0;
    ...
    public static final String UPLOAD_IMAGE_INTENT_PARAMS = "com.cooyet.im.upload.image.intent";
    /**
     * event 优先级
     * */
