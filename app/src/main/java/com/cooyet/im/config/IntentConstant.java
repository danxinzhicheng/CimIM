...
public class IntentConstant {
    ...
    public static final String CUR_MESSAGE_TAG_GPS_LATITUDE = "CUR_MESSAGE_TAG_GPS_LATITUDE";
    public static final String CUR_MESSAGE_TAG_GPS_LONGITUDE = "CUR_MESSAGE_TAG_GPS_LONGITUDE";
